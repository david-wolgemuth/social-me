...
class ContactsViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,ConnectionDelegate{
    ...
    override func viewDidLoad() {
        ...
        let overwrite: Bool = CoreDataManager.sharedInstance.get_overwrite()
